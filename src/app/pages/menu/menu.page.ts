...
export class MenuPage implements OnInit {
  ...
  public itemes_Sucursales: Array<{ titulo: string, page: string, item: string }> = [
    ...
    { titulo: 'Visitas últimas 4 semanas',  page: 'ventas002', item: 'Visitas últimas 4 semanas' },
    { titulo: 'Ventas últimas 4 semamnas',  page: 'ventas003', item: 'Ventas últimas 4 semamnas' }
